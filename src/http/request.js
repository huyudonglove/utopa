...
export function identifyUpload(params) {
  return loadRequest('/api/utopa/ar/identify/image/upload/data/package', params, '保存上传', http, 'post')
}
...
export function addMiddleUser(params){
  return loadRequest('/api/utopa/ar/saas/account/add',params,'创建',http,'post')
}
/** 中台用户配置-编辑中台用户 Author:minggui*/
export function editMiddleUser(params){
  return loadRequest('/api/utopa/ar/saas/account/update',params,'修改',http,'post')
}
...
export function applicationUpper(params) {
  return loadRequest('/api/utopa/ar/background/app/upper', params, '上架', http, 'get')
}
/** 应用管理-下架 w*/
export function applicationLower(params) {
  return loadRequest('/api/utopa/ar/background/app/lower', params, '下架', http, 'get')
}
/** 应用管理-玩法 w*/
