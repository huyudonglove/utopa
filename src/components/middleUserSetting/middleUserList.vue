  ...
  <div v-if="middleUserPower.length">
    <div v-if="$route.name=='middleUserList'">
      <div style="height:50px;border-bottom:1px solid #DFDCDC;">
        ...
        <el-button :disabled="!middleUserPower[0].isCheck" style="float:right;" type="primary" @click="$router.push({path:'/middleusersetting/middleuserlist/createmiddleuser',query:{oldQuery:JSON.stringify($route.query)}})">新建</el-button>
      </div>
      <el-row class="tac" style="border-bottom:1px solid #eeeeee; padding:15px 0;">
        ...
        <el-button type="primary" plain @click="del" :disabled="!middleUserPower[3].isCheck">批量删除</el-button>
      </el-row>
