<template>
    <div>
      ...
      <div style="margin-top: 10px;margin-bottom: 10px">
        <el-input v-model="word" style="width: 500px"></el-input>
      ...
      <div>
        <div ><!--音乐-->
          <el-table :data="tableData" style="width: 100%" :max-height="tableHeight" ref="playRef" border>
            ...
            <el-table-column prop="name" label="玩法名称" width="180">
            </el-table-column>
            <el-table-column prop="key" label="key">
            </el-table-column>
            <el-table-column  label="包含素材">
      ...
      <div>
        <el-dialog title="素材种类详情" :visible.sync="visible" width="40%" ><!--详情弹窗-->
          <div style="padding-left: 30px">
            <div >
              <el-input style="width: 200px" v-model="moduleName"></el-input>
              <el-button type="primary" >搜索</el-button>
            </div>
            <div style="margin-top: 10px;margin-bottom: 10px;">
              <el-table :data="detailData" style="width: 90%" border >
                <el-table-column prop="moduleName" label="功能名" width="180">
                </el-table-column>
                <el-table-column  label="所属玩法" width="180">
                  <template>
                    {{playName}}
                  </template>
                </el-table-column>
                <el-table-column label="玩法说明" >
                  <template>
                    {{remark}}
                  </template>
                </el-table-column>
