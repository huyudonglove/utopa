<template>
    <div v-if="typePower.length">
      <div style="height:50px;border-bottom:1px solid #DFDCDC;">
        ...
        <el-button style="float:right;" type="primary" @click="dialogVisible=true" :disabled="!typePower[0].isCheck">新建</el-button>
      </div>
      <div style="margin-top: 10px;margin-bottom: 10px;">
        <el-input v-model="word" style="width: 200px;"></el-input>
        <el-button type="primary" @click="getmaterial()">搜索</el-button>
        <span>
        创建时间
        ...
        <el-button @click="delectAll" :disabled="!typePower[3].isCheck">批量删除</el-button>
      </div>
      <div>
        <el-table :data="tableData" border style="width: 100%" @selection-change="selectAll" :max-height="tableHeight" ref="mangerRef">
          ...
          <el-table-column fixed="right" label="操作" >
            <template slot-scope="scope">
              <el-button type="text" size="small" @click="module=scope.row.module+'';dialogVisible=true;getTree();" :disabled="!typePower[1].isCheck">编辑</el-button>
            </template>
          </el-table-column>
        </el-table>
      </div>
